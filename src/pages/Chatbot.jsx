...
import { Bot, User, Home, Send, Plus, Trash2, Menu, X } from 'lucide-react';
...
const Chatbot = () => {
    ...
    return (
        <div className="flex h-screen w-screen bg-emerald-50">
            {/* Sidebar */}
            <div className={`${sidebarOpen ? 'w-64' : 'w-0'} bg-green-900 text-white transition-all duration-300 flex flex-col h-full`}>
                {sidebarOpen && (
                    <>
                        <div className="p-4">
                            <button 
                        ...
                        <div className="flex-1 overflow-y-auto">
                            {savedConversations.map(conversation => (
                                <div 
                                    ...
                                    className={`flex items-center justify-between p-3 cursor-pointer hover:bg-green-200 transition ${currentConversationId === conversation.id ? 'bg-green-500' : ''}`}
                                >
            ...
            <div className="flex-1 flex flex-col">
                {/* Header */}
                <div className="bg-gradient-to-r from-green-600 to-emerald-500 text-white font-bold p-4 flex items-center justify-between shadow-md">
                ...
                <div className="flex-1 p-4 overflow-y-auto bg-emerald-50">
                    {chatHistory.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full">
                            <Bot size={48} className="text-green-600 mb-4" />
                            <h2 className="text-2xl font-semibold text-gray-700 mb-2">How can I support your wellness today?</h2>
                            <p className="text-center text-gray-500 max-w-md">Ask about Ayurveda, Panchakarma, or general guidance 🌿</p>
                        </div>
                    ) : (
                        chatHistory.map((chat, index) => (
                            ...
                            >
                                ...
                                <div
                                    className={`max-w-[75%] px-5 py-3 rounded-2xl shadow ${
                                        chat.role === 'user'
                                            ...
                                            : 'bg-green-50 text-green-900 rounded-tl-none border border-green-200'
                                    }`}
                                >
                                ...
                                {chat.role === 'user' && (
                                    <div className="bg-amber-100 p-2 rounded-full ml-2">
                    ...
                    {isBotTyping && (
                        <div className="flex items-center justify-start mb-4">
                            ...
                            <div className="bg-green-50 text-gray-800 px-5 py-3 rounded-2xl shadow rounded-tl-none border border-green-200">
                ...
                <div className="flex items-center gap-3 p-4 bg-white border-t border-gray-200">
                    <input
                        ...
                        className="flex-1 px-4 py-3 text-sm border border-gray-300 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                    />
                    <button
